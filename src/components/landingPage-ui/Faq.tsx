...
function Faq() {
  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-gray-900 pt-20">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20 dark:text-white">
              ...
              <p className="text-base text-body-color">
                Find Quick Answers. Get started on ShopPlusPlus with our curated
          ...
          <div className="w-full px-4 lg:w-1/2">
              ...
              >
                ...
                <div className="w-full">
                  <h4 className="text-lg font-semibold text-black">
                    How does ShopPlusPlus differ from other bulk trading
                    platforms?
                  </h4>
                </div>
              </button>
              {openFaq1 && (
                <div className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    ShopPlusPlus stands out from the competition with its no-fee
                    transactions, secure platform, and global
            ...
            <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
              ...
              >
                ...
                <div className="w-full">
                  <h4 className="text-lg font-semibold text-black">
                    How can I buy and sell products on ShopPlusPlus?
                  </h4>
                </div>
              </button>
              {openFaq2 && (
                <div className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    To buy and sell products on ShopPlusPlus, simply sign up for
                    an account and list your products or start browsing.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
              ...
              >
                ...
                <div className="w-full">
                  <h4 className="text-lg font-semibold text-black">
                    Is it safe to trade on ShopPlusPlus?
                  </h4>
                </div>
              </button>
              {openFaq3 && (
                <div className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    Yes, ShopPlusPlus is a secure platform that uses cards
            ...
            <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
              ...
              >
                ...
                <div className="w-full">
                  <h4 className="text-lg font-semibold text-black">
                    How can I track my orders and sales on ShopPlusPlus?
                  </h4>
                </div>
              </button>
              {openFaq4 && (
                <div className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    ShopPlusPlus offers an intuitive dashboard that allows you to
