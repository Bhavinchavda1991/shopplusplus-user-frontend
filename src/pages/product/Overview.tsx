                ...
                <div className="w-full xl:flex xl:flex-row-reverse">
                  <div className="shrink-0 w-full xl:ltr:ml-5 xl:rtl:mr-5 mb-2.5 md:mb-3 border border-border-base overflow-hidden rounded-md relative xl:w-[480px] 2xl:w-[650px]">
                    <div className="flex items-center justify-center relative">
                      ...
                      <button
                        ...
                        className={`absolute top-0 right-4 mt-4 inline-flex items-center justify-center space-x-2 px-4 py-2 rounded-full font-medium transition-all ${liked
                      ...
                      >
                        <svg
                          ...
                          className={`h-5 w-5 ${liked ? "text-white" : "text-gray-700"
                            }`}
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        >
                  ...
                  <div className="flex xl:flex-col gap-2">
                    {product.data?.imagesUrl.map((image: any, index: any) => (
                      <div
                        key={index}
                        className={`flex items-center justify-center overflow-hidden transition border rounded cursor-pointer border-border-base ${currentImage === index &&
