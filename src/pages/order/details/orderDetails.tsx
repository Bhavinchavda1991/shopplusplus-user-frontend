                ...
                {orders &&
                  orders.map((order: any, index: any) => (
                    <div
                      ...
                      role="button"
                      className={`mb-4 flex w-full shrink-0 cursor-pointer flex-col overflow-hidden rounded border-2 bg-gray-100 dark:bg-gray-700 dark:text-white last:mb-0 ${activeOrder._id === order._id && "border-green-600"
                        } `}
                    >
                      <div className="flex items-center justify-between border-b py-3 px-5 md:px-3 lg:px-5 ">
                        ...
                        <span
                          className={`max-w-full truncate whitespace-nowrap rounded px-3 py-2 text-sm text-white ${order.orderStatus === "Placed"
                              ? "bg-[#F59E0B]"
                    ...
                    <div className="order-2 flex w-full gap-6 xs:flex-nowrap sm:order-1 max-w-full basis-full justify-between">
                      <div className="flex flex-wrap items-center">
                        ...
                        <div className="w-full lg:w-auto">
                          <span
                            className={`px-3 py-2 rounded-full text-center text-white text-sm  min-h-[2rem] items-center justify-center !leading-none xs:text-sm inline-flex ${activeOrder.orderStatus === "Placed"
                                ? "bg-[#F59E0B]"
                      ...
                      <div className="flex flex-wrap items-center">
                        ...
                        <div className="w-full lg:w-auto">
                          <span
                            className={`px-3 py-2 rounded-full text-sm text-center text-white min-h-[2rem] items-center justify-center !leading-none xs:text-sm inline-flex ${activeOrder.transactionId.status === "Completed"
                                ? "bg-green-600"
                      ...
                      <div className="h-full w-full dark:text-white">
                        <div className="flex flex-col md:flex-row py-7">
                          ...
                          <div className="flex md:flex-col w-full md:w-1/5 relative pb-6 ">
                            <div className="flex justify-center items-center md:mb-4">
                              <div
                                className={`${activeOrder.orderStatus === "Confirmed" ||
                                    activeOrder.orderStatus === "Shipped" ||
                                    activeOrder.orderStatus === "Delivered" ||
                                    activeOrder.orderStatus === "Completed"
                                    ? "bg-green-600"
                          ...
                          <div className="flex md:flex-col w-full md:w-1/5 relative pb-6 ">
                            <div className="flex justify-center items-center md:mb-4">
                              <div
                                className={`${activeOrder.orderStatus === "Shipped" ||
                                    activeOrder.orderStatus === "Delivered" ||
                                    activeOrder.orderStatus === "Completed"
                                    ? "bg-green-600"
                                    : "bg-gray-200"
                          ...
                          <div className="flex md:flex-col w-full md:w-1/5 relative pb-6 ">
                            <div className="flex justify-center items-center md:mb-4">
                              <div
                                className={`${activeOrder.orderStatus === "Delivered" ||
                                    activeOrder.orderStatus === "Completed"
                                    ? "bg-green-600"
                                    : "bg-gray-200"
                                  } absolute -top-1/4 md:top-auto md:left-0 h-full md:h-1 w-1 md:w-full`}
                          ...
                          <div className="flex md:flex-col w-full md:w-1/5 relative pb-6 ">
                            <div className="flex justify-center items-center md:mb-4">
                              <div
                                className={`${activeOrder.orderStatus === "Completed"
                                    ? "bg-green-600"
                                    : "bg-gray-200"
                                  } absolute -top-1/4 md:top-auto md:left-0 h-full md:h-1 w-1 md:w-full`}
                              />
              ...
              activeOrder.trackingDetails && (
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="mb-2 md:mb-0">
                    ...
                    <span
                      className={`capitalize ${activeOrder.trackingDetails.deliveryStatus ===
                          "Delivered"
                          ? "text-green-500"
